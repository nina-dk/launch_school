...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: ninadk
--
...
ALTER TABLE public.weather OWNER TO ninadk;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: ninadk
--
