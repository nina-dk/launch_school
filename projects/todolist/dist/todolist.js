...
var TodoList = /*#__PURE__*/function () {
  ...
  _createClass(TodoList, [{
    ...
    key: "filter",
    value: function filter(title, callback) {
      var filtered = this.todos.filter(callback);
      var filteredList = new TodoList(title);
      filtered.forEach(function (todo) {
        return filteredList.add(todo);
      });
      return filteredList;
    }
  }, {
    ...
    value: function findByTitle(title) {
      return this.filter(title, function (todo) {
    ...
    value: function allDone() {
      return this.filter("Done Todos", function (todo) {
        return todo.isDone();
      });
    }
  }, {
    ...
    value: function allNotDone() {
      return this.filter("Not done Todos", function (todo) {
        return !todo.isDone();
      });
    }
  }, {
